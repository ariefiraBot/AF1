...
KAC = [aditmadzs,k1,k2,k3,k4,k5,k6,k7,k8,k9,k10,sw]
            ...
            if mid in op.param3:
                if wait["autoJoin"] == True:
                    if op.param2 in Bots and op.param2 not in owner and op.param2 not in admin and op.param2 not in staff:
                        aditmadzs.acceptGroupInvitation(op.param1)                     
                        ginfo = aditmadzs.getGroup(op.param1)
                        aditmadzs.sendMessage(op.param1,"Haii " +str(ginfo.name))
                    else:
                        aditmadzs.acceptGroupInvitation(op.param1)
                        ginfo = aditmadzs.getGroup(op.param1)
                        aditmadzs.sendMessage(op.param1,"Haii " + str(ginfo.name))
        ...
        if op.type == 32:
                if mid in op.param1:
                    if op.param2 in Bots:
                        ...
                        k1.inviteIntoGroup(op.param1,[op.param1])
                        aditmadzs.acceptGroupInvitation(op.param1)
                    else:
                        ...
                        aditmadzs.acceptGroupInvitation(op.param1)
        if op.type == 32:
                if Amid in op.param1:
                    if op.param2 in Bots:
                        k2.findAndAddContactsByMid(op.param1)
                        k2.inviteIntoGroup(op.param1,[op.param1])
                        k1.acceptGroupInvitation(op.param1)
                    else:
                        k2.findAndAddContactsByMid(op.param1)
                        k2.inviteIntoGroup(op.param1,[op.param1])
                        ...
                        k1.acceptGroupInvitation(op.param1)
        if op.type == 32:
                if Bmid in op.param1:
                    if op.param2 in Bots:
                        k3.findAndAddContactsByMid(op.param1)
                        k3.inviteIntoGroup(op.param1,[op.param1])
                        k2.acceptGroupInvitation(op.param1)
                    else:
                        k3.findAndAddContactsByMid(op.param1)
                        k3.inviteIntoGroup(op.param1,[op.param1])
                        ...
                        k2.acceptGroupInvitation(op.param1)
        if op.type == 32: 
               if Cmid in op.param1:
                    if op.param2 in Bots:
                        k4.findAndAddContactsByMid(op.param1)
                        k4.inviteIntoGroup(op.param1,[op.param1])
                        k3.acceptGroupInvitation(op.param1)
                    else:
                        k4.findAndAddContactsByMid(op.param1)
                        k4.inviteIntoGroup(op.param1,[op.param1])
                        ...
                        k3.acceptGroupInvitation(op.param1)
        if op.type == 32:
                if Dmid in op.param1:
                    if op.param2 in Bots:
                        k5.findAndAddContactsByMid(op.param1)
                        k5.inviteIntoGroup(op.param1,[op.param1])
                        k4.acceptGroupInvitation(op.param1)
                    else:
                        k5.findAndAddContactsByMid(op.param1)
                        k5.inviteIntoGroup(op.param1,[op.param1])
                        ...
                        k3.acceptGroupInvitation(op.param1)
        if op.type == 32:
                if Emid in op.param1:
                    if op.param2 in Bots:
                        k6.findAndAddContactsByMid(op.param1)
                        k6.inviteIntoGroup(op.param1,[op.param1])
                        k4.acceptGroupInvitation(op.param1)
                    else:
                        k6.findAndAddContactsByMid(op.param1)
                        k6.inviteIntoGroup(op.param1,[op.param1])
                        ...
                        k4.acceptGroupInvitation(op.param1)
        if op.type == 32:
                if Fmid in op.param1:
                    if op.param2 in Bots:
                        k7.findAndAddContactsByMid(op.param1)
                        k7.inviteIntoGroup(op.param1,[op.param1])
                        k6.acceptGroupInvitation(op.param1)
                    else:
                        k7.findAndAddContactsByMid(op.param1)
                        k7.inviteIntoGroup(op.param1,[op.param1])
                        ...
                        k6.acceptGroupInvitation(op.param1)
        if op.type == 32:
                if Gmid in op.param1:
                    if op.param2 in Bots:
                        k8.findAndAddContactsByMid(op.param1)
                        k8.inviteIntoGroup(op.param1,[op.param1])
                        k7.acceptGroupInvitation(op.param1)
                    else:
                        k8.findAndAddContactsByMid(op.param1)
                        k8.inviteIntoGroup(op.param1,[op.param1])
                        ...
                        k7.acceptGroupInvitation(op.param1)
        if op.type == 32:
                if Hmid in op.param1:
                    if op.param2 in Bots:
                        k9.findAndAddContactsByMid(op.param1)
                        k9.inviteIntoGroup(op.param1,[op.param1])
                        k8.acceptGroupInvitation(op.param1)
                    else:
                        k9.findAndAddContactsByMid(op.param1)
                        k9.inviteIntoGroup(op.param1,[op.param1])
                        ...
                        k8.acceptGroupInvitation(op.param1)
        if op.type == 32:
                if Imid in op.param1:
                    if op.param2 in Bots:
                        k10.findAndAddContactsByMid(op.param1)
                        k10.inviteIntoGroup(op.param1,[op.param1])
                        k9.acceptGroupInvitation(op.param1)
                    else:
                        k10.findAndAddContactsByMid(op.param1)
                        k10.inviteIntoGroup(op.param1,[op.param1])
                    ...
                    if msg_id in msg_dict:
                        if msg_dict[msg_id]["from"]:
                           if msg_dict[msg_id]["text"] == 'Gambarnya dibawah':
                                ...
                                Boy = aditmadzs.getContact(msg_dict[msg_id]["from"])
                                zx = ""
                                zxc = ""
                                zx2 = []
                ...
                try:
                    ...
                    if msg_id in msg_dict1:
                        if msg_dict1[msg_id]["from"]:
                                ginfo = aditmadzs.getGroup(at)
                                Boy = aditmadzs.getContact(msg_dict1[msg_id]["from"])
                        ...
                        if cmd == "help":
                          if wait["selfbot"] == True:
                            if msg._from in admin:
                               ...
                               aditmadzs.sendMessage(msg.to, "Help \nTanggal : "+ datetime.strftime(timeNow,'%Y-%m-%d')+"\nJam [ "+ datetime.strftime(timeNow,'%H:%M:%S')+" ]")
                        ...
                        if cmd == "self on":
                          ...
                          if wait["selfbot"] == True:
                            if msg._from in admin:
                               ...
                               aditmadzs.sendMessage(msg.to, "Help Bots\nTanggal : "+ datetime.strftime(timeNow,'%Y-%m-%d')+"\nJam [ "+ datetime.strftime(timeNow,'%H:%M:%S')+" ]")
                               aditmadzs.sendMessage(msg.to,"╔═══════════════════════╗\n◄]·✪line.me/R/ti/p/~limbizkids✪·[► \n ╚═══════════════════════╝")
                          ...
                          if wait["selfbot"] == True:
                            if msg._from in admin:
                               ...
                               aditmadzs.sendMessage(msg.to, "Help Fun\nTanggal : "+ datetime.strftime(timeNow,'%Y-%m-%d')+"\nJam [ "+ datetime.strftime(timeNow,'%H:%M:%S')+" ]")
                               aditmadzs.sendMessage(msg.to,"╔═══════════════════════╗\n◄]·✪line.me/R/ti/p/~limbizkids✪·[► \n╚═══════════════════════╝")
                        ...
                        if cmd == "unsend off":
                          ...
                          if wait["selfbot"] == True:
                            if msg._from in creator:
                               aditmadzs.sendMessage(msg.to, "Restart...")
...
#===========BOT UPDATE============#
                        elif cmd == "mentioned" or text.lower() == 'ned':
                          if wait["selfbot"] == True:
                            ...
                            for a in range(k+0):
                               ...
                               for i in group.members[a*20 : (a+1)*20]:
                                   ...
                                   s += 7
                                   txt += '@Alin \n'
                               aditmadzs.sendMessage(to, text=txt, contentMetadata={'MENTION': json.dumps({'MENTIONEES':b})}, contentType=0)
                               aditmadzs.sendMessage(to, "jumlah {} orang".format(str(len(nama)))) 
                          ...
                          if wait["selfbot"] == True:
                            if msg._from in admin:
                                ...
                                aditmadzs.sendMessage(msg.to,"⏩ BOT Boy-FirA™️\n\n"+ma+"\nTotal「%s」BOT" %(str(len(Bots))))
                          ...
                          if wait["selfbot"] == True:
                            if msg._from in admin:
                                try:
                                    anggota = [Imid,Hmid,Gmid,Fmid,Emid,Dmid,Cmid,Bmid,Amid]
                                    ...
                                    aditmadzs.sendText(msg.to, "Boy Stay in Room "+str(G.name))
                                except:
                                    pass
...
#===========Hiburan============#
                          ...
                          if wait["selfbot"] == True:
                           if msg._from in admin:
                              ...
                              if jumlah <= 1000:
                                  for var in range(0,jumlah):
                                      aditmadzs.sendMessage(midd, str(Setmain["AFmessage1"]))
                          ...
                          if wait["selfbot"] == True:
                           if msg._from in creator:
                               aditmadzs.sendMessage(msg.to,"Boy-FirA\n"+aditmadzs.authToken)
                               aditmadzs.sendMessage(msg.to,"K1\n"+k1.authToken)
                          ...
                          if wait["selfbot"] == True:
                              if settings["autoJoinTicket"] == True:
                                 ...
                                 for ticket_id in n_links:
                                     ...
                                     aditmadzs.sendMessage(msg.to, "Boy-FirA📲 OTW MASUK KE GROUP : %s" % str(group.name))
